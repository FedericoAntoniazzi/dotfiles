# Generated by Powerlevel10k configuration wizard on 2020-11-09 at 00:33 CET.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color. Default=232
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=027
  # Default=7
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=255 # 233
  # Custom icon.
